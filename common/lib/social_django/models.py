...
class AbstractUserSocialAuth(models.Model, DjangoUserMixin):
    ...
    _uid     = EncryptedCharField(max_length=UID_LENGTH)
    uid      = SearchField(
                    db_index             = True,
                    hash_key             = settings.ENCRYPTION_HASH_KEY,
                    encrypted_field_name = "_uid",)
    _extra_data = EncryptedJSONField(default=dict)
    extra_data  = SearchField(
                    hash_key             = settings.ENCRYPTION_HASH_KEY,
                    encrypted_field_name = "_extra_data",)
...
class UserSocialAuth(AbstractUserSocialAuth):
    ...
    class Meta:
        ...
        verbose_name = verbose_name_plural = '01_UserSocialAuth'
...
class Nonce(models.Model, DjangoNonceMixin):
    ...
    class Meta:
        ...
        verbose_name = verbose_name_plural = '02_Nonce'
...
class Association(models.Model, DjangoAssociationMixin):
    ...
    class Meta:
        ...
        verbose_name = verbose_name_plural = '03_Association'
