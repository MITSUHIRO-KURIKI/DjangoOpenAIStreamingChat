...
STRATEGY = getattr(
    settings, setting_name("STRATEGY"), "common.lib.social_django.strategy.DjangoStrategy"
)
STORAGE = getattr(
    settings, setting_name("STORAGE"), "common.lib.social_django.models.DjangoStorage"
)
